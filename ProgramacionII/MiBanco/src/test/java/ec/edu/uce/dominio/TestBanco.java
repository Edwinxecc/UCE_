...
public class TestBanco {
    ...
    public static void main(String[] args) {
        ...
        boolean agregado1 = banco.agregarEmpleado(new Empleado("Empleado", "Generico", Genero.OTRO, 1200.0));
        System.out.println("Empleado Genérico agregado: " + (agregado1 ? "Sí" : "No"));
        assert agregado1 : "¡Fallo al agregar Empleado Generico!";

        boolean agregado2 = banco.agregarEmpleado(new Empleado("Laura", "Sanchez", Genero.FEMENINO, 1350.0));
        ...
        boolean agregado4 = banco.agregarEmpleado(new Director("Pedro", "Gomez", Genero.MASCULINO, 3500.0, "IT", 60000.0, 0.0));
